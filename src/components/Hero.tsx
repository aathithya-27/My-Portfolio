const Hero = () => (
  <section className="relative flex flex-col items-center justify-center min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white px-4 overflow-hidden transition-colors duration-300">
    {/* Animated Gradient Background */}
    <div className="absolute inset-0 -z-10 bg-gradient-to-br from-purple-200 via-fuchsia-200 to-indigo-200 dark:from-purple-700 dark:via-fuchsia-600 dark:to-indigo-700 opacity-50 animate-gradientBG bg-[length:200%_200%] transition-colors duration-300" />
